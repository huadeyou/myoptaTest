...
public class CreateExcelFile {
    ...
    public static void writeToExcelXls(String fileDir, String sheetName, List<TaskMix> taskList) throws Exception {
        ...
        try {
            ...
            if (titleRow != null) {
                for (int rowId = 0; rowId < taskList.size(); rowId++) {
                    TaskMix task = taskList.get(rowId);
                    ...
                    for (short columnIndex = 0; columnIndex < columnCount; columnIndex++) {  //遍历表头
                        ...
                        switch (titleString)
                        {
                            ...
                            case "sku":
                                ...
                                break;
                            case "productSku":
                                cell.setCellValue(task.getProductSku());
                                break;
                            case "appointMachine":
                            ...
                            case "endTime":
                                ...
                                break;
                            case "demandCases":
                                cell.setCellValue(task.getDemandTons());
                                break;
                        }
                    }
                }
    ...
    public  void outPutResult(String fileDir, List<TaskMix> taskList, Map<String,List<List<Integer>>> totalMachineTransTimeMap) {
...
//        String fileDir = "d:\\workbook.xls";
        ...
        String[] title1 = {"id", "sku","productSku", "appointMachine","startTime","endTime","demandCases"};
